...
import { AlphaDuelGame } from './games/alpha-duel/AlphaDuelGame';

const GAME_ID = 'alpha-duel';
const GAME_TITLE = import.meta.env.VITE_GAME_TITLE || 'Alpha Duel';
      ...
      {!hasContract ? (
        <div className="card">
          ...
          <p style={{ color: 'var(--color-ink-muted)', marginTop: '1rem' }}>
            ...
            <code>VITE_ALPHA_DUEL_CONTRACT_ID</code> in the root <code>.env</code>.
          </p>
        </div>
      ) : !devReady ? (
        <div className="card">
